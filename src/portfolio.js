...
const skillsSection = {
  ...
  skills: [
    emoji("⚡ Build responsive and dynamic web/mobile applications using React Native and Django"),
    emoji("⚡ Develop RESTful APIs and integrate third-party services like Firebase and Cloudinary"),
    emoji("⚡ Experience with DevOps basics such as Docker and Jenkins for deployment and automation"),
    emoji("⚡ Implement database management systems including MySQL, SQLite, and SQL Server"),
    emoji("⚡ Real-time features like chat system using Firebase in mobile e-commerce platforms")
  ],
  softwareSkills: [
    {
      skillName: "HTML5",
    ...
    {
      skillName: "Django",
      fontAwesomeClassname: "fas fa-leaf" // custom or alternative icon, Font Awesome không có Django chính thức
    },
    {
      skillName: "Flask",
  ...
  schools: [
    {
      ...
      logo: require("./assets/images/hcmoulogo.png"), // bạn có thể đổi tên file logo này thành logo trường bạn
  ...
  experience: [
    {
      ...
      companylogo: require("./assets/images/auavagologo.png"), // Bạn cần thêm logo công ty nếu có
